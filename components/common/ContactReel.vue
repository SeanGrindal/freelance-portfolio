	...
	<div class="Contact-Reel">
		<div :class="['Contact-Reel__contacts', `speed--${speed}`]">
			<template v-for="n in 4">
				<a href="mailto:sean@grindal.me" target="_blank" rel="external">
				...
				<a href="https://github.com/SeanGrindal" target="_blank">
				...
				<a href="https://twitter.com/GrindalSean" target="_blank" rel="external">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
						<path
				...
				<a
					href="https://www.linkedin.com/in/sean-grindal-b26b0918b/"
					target="_blank"
					rel="external"
				>
				...
				<a href="https://medium.com/@sean37gl" target="_blank" rel="external">
